...
def check_keys(model, pretrained_state_dict):
    ...
    if len(missing_keys) > 0:
        logger.info(f'[Warning] missing keys: {missing_keys}')
        logger.info(f'missing keys:{len(missing_keys)}')
    if len(unused_pretrained_keys) > 0:
        logger.info(f'[Warning] unused_pretrained_keys: '
                    f'{unused_pretrained_keys}')
        logger.info(f'unused checkpoint keys:{len(unused_pretrained_keys)}')
    logger.info(f'used keys:{len(used_pretrained_keys)}')
